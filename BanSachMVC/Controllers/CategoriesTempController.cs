...
namespace BanSachMVC.Controllers
{
    public class CategoriesTempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,DisplayOrder,CreateTime")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DisplayOrder,CreateTime")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
